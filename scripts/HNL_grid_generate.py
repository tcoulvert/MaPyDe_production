#generate events with eta and pt cuts for more event generation
import os,sys
import numpy as np
import math
...
mN    = np.array([0.1, 0.5,1,2,3, 4,4.5, 5, 6,7, 8,5,10,15,20,2.1, 2.2, 2.5,3.2,3.5, 3.8, 3.9, 3.6, 3.7, 4.1,4.2,4.5,5.5, 3.55, 4.6, 4.7, 3.3, 3.4, 3.1, 3.05, 2.8, 5.3, 5.4, 5.32, 5.35, 5.38])
